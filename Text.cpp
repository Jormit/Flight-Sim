...
Text::Text(int screenWidth, int screenHeight, const char *font) :
shader("../shaders/text/vect.glsl", "../shaders/text/frag.glsl") {

    projection = glm::ortho(0.0f, static_cast<GLfloat>(screenWidth),
